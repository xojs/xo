...
*Vue components aren't supported by default, you'll need [eslint-onfig-xo-vue](https://github.com/ChocPanda/eslint-config-xo-vue#use-with-xo) for specific linting in a VueJS app*
