...
const processOverridesForFile = (file, opts) => {
	...
	const filename = path.relative(opts.cwd, file);

	const foundOverrides = findApplicableOverrides(filename, overrides);
	return mergeApplicableOverrides(opts, foundOverrides.applicable);
};
...
module.exports.processOverridesForFile = processOverridesForFile;
